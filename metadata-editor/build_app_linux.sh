...
JAVA_VERSION=17
MAIN_JAR="metadata-editor-app-$PROJECT_VERSION.jar"
...
--main-class com.moura.metadataeditor.Launcher \
--main-jar ${MAIN_JAR} \
--java-options -Xmx2048m \
--runtime-image target/java-runtime \
--resource-dir src/main/resources/utils/ \
--icon src/main/resources/images/icon.png \
--app-version ${APP_VERSION} \
--vendor "De Moura" \
--copyright "Copyright © 2021-22 De Moura"
